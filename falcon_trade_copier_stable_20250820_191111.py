...
class TelegramPage(QWidget):
    ...
    def setup_ui(self):
        ...
        input_row.addStretch()  # Push everything to the left
...
class DashboardPage(QWidget):
    ...
    def setup_ui(self):
        ...
        telegram_label.setStyleSheet("font-size: 13px; font-weight: bold; color: #f0f4f9;")
        ...
        mt5_label.setStyleSheet("font-size: 13px; font-weight: bold; color: #f0f4f9;")
...
3. Provide your current license key for upgrade pricing
    ...
    def update_connection_status(self, telegram_status=None, mt5_status=None):
        ...
        # Update Telegram status with compact styling
        if telegram_status:
        ...
        # Update MT5 status with compact styling
        if mt5_status:
        ...
        try:
            ...
            if hasattr(self, 'start_btn') and hasattr(self, 'stop_btn'):
                if width < 800:
                    ...
                    self.start_btn.setText("▶️ Start Copy")
                    self.stop_btn.setText("⏹️ Stop Copy")
                else:
                    self.start_btn.setText("▶️ Start Copying")
                    self.stop_btn.setText("⏹️ Stop Copying")
