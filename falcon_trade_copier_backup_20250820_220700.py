    ...
    def setup_ui(self):
        ...
        self.telegram_status.setStyleSheet("""
            QLabel {
                ...
                padding: 6px 10px;
                border-radius: 6px;
                background-color: rgba(29, 158, 74, 0.15);
                color: #1d9e4a;
...
3. Provide your current license key for upgrade pricing
    ...
    def update_connection_status(self, telegram_status=None, mt5_status=None):
        ...
        # Update Telegram status with enhanced styling
        if telegram_status:
            ...
            self.telegram_status.setStyleSheet("""
                QLabel {
                    ...
                    padding: 6px 10px;
                    border-radius: 6px;
                    background-color: rgba(245, 78, 78, 0.15);
                    color: #f54e4e;
        ...
        # Update MT5 status with enhanced styling
        if mt5_status:
